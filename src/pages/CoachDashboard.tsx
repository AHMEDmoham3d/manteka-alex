...
import type { ExamPeriod, SecondaryRegistrationPeriod, TournamentPeriod } from '../lib/supabase';
import { LogOut, Search, UserCircle, CheckCircle, XCircle, Download, BookOpen, Trophy } from 'lucide-react';
...
export default function CoachDashboard() {
  ...
  const [activeTournament, setActiveTournament] = useState<TournamentPeriod | null>(null);
  ...
  useEffect(() => {
    const loadCoachData = async () => {
      ...
      try {
        ...
        // جلب تسجيلات البطولة الحالية للمدرب
